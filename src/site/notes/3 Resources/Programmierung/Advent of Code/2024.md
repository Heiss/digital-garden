---
{"dg-publish":true,"permalink":"/3-resources/programmierung/advent-of-code/2024/","created":"2024-12-03T16:43:26.902+01:00","updated":"2024-12-10T00:05:45.020+01:00"}
---
...
Mh. Okay a second day in a row, which is not very hard but fun to implement. In my implementation, i tried to reuse my structs from part 1 and using wrapper structs. On this day, you need to learn how to access an array without violation the borrow checker. But working on arrays with rust feels a lot like C and the borrow checker is not so rigid as in other situations.
